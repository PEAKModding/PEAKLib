...
- Items not having translations and therefore having "LOC:" in their names and stuff ([#56](<https://github.com/PEAKModding/PEAKLib/pull/56>))

## [1.6.1] - 2026-08-31

### Fixed

- Multi-hand feature being broken ([#55](<https://github.com/PEAKModding/PEAKLib/pull/55>))
